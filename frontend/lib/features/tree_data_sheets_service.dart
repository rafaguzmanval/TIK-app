...
class TreeDataSheetService {
  ...
  void updateTreeDataSheet({
    ...
    try {
      ...
      showFlutterToast(
          msg: "¡Ficha de datos actualizada correctamente!", isSuccess: true);
    } catch (err) {
      showFlutterToast(msg: err.toString(), isSuccess: false);
    }
  }
...
// Get user data, for init state
  ...
  Future deleteTreeDataSheet(
      {required BuildContext context, required TreeDataSheet treeDataSheet}) async {
    try {
